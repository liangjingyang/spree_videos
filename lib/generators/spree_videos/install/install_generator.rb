  ...
  module Generators
    class InstallGenerator < Rails::Generators::Base
      ...
      def add_stylesheets
        ...
        inject_into_file 'vendor/assets/stylesheets/spree/backend/all.css', " *= require spree/backend/spree_videos\n", before: /\*\//, verbose: true
      end

      def add_migrations
        run 'bundle exec rake railties:install:migrations FROM=spree_videos'
      end
